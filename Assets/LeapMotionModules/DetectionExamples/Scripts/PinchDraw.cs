...
namespace Leap.Unity.DetectionExamples
{
    ...
    public class PinchDraw : MonoBehaviour
    {
        ...
        private class DrawState
        {
            ...
            {
                if (ringPosition.x > XMax | ringPosition.x < XMin | ringPosition.y > YMax | ringPosition.y < YMin |
                    ringPosition.z > ZMax | ringPosition.z < ZMin)
                {
                    return;
                }
                ...
                //ringPosition.z = Random.Range(.28F,.281F);
                //ringPosition.z = UseThisZ;
                //ringPosition.z = .28F;
                Debug.Log("Drawing at (" + ringPosition.x + "," + ringPosition.y + "," + ringPosition.z + ")");
